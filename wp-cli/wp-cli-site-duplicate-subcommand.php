...
if ( class_exists( 'MUCD_Functions' ) && ! class_exists( 'Site_Duplicate_Subcommand' ) ) :
	...
	/**
	 * WP-CLI command to duplicate a site in a multisite install.
	 */
	class Site_Duplicate_Subcommand extends WP_CLI_Command {
		 ...
		 *
		 * @param array $_          positional args (unused)
		 * @param array $assoc_args associative args, see OPTIONS above
		 */
		public function __invoke( $_, $assoc_args ) {
			...
			} elseif ( isset( $assoc_args['porcelain'] ) ) {
